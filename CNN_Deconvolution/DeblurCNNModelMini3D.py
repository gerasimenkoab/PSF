...
class DeblurCNNModelMini3D:
    ...
    def ModelBuilder(input_shape = (64, 64, 40, 1), learning_rate = 0.001):
        ...
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv0')(X_input)
        stageZeroOutput = layers.LeakyReLU()(X)

        # Stage 1: first Residual layer with (3x3) kernels and (64, 64, 1) input_shape
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv1_1', padding='same')(stageZeroOutput)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (9, 9, 9), name = 'conv1_2', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv1_3', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv2_1', padding='same')(stageOneOutput)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (7, 7, 7), name = 'conv2_2', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv2_3', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv3_1', padding='same')(stageTwoOutput)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (5, 5, 5), name = 'conv3_2', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv3_3', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        StageTwoLongcut = layers.Conv3D(32, (1, 1, 1), name = 'conv4_1', padding='same')(StageTwoLongcut)
        StageTwoLongcut = layers.LeakyReLU()(StageTwoLongcut)

        X = layers.Conv3D(32, (1, 1, 1), name = 'conv4_2', padding='same')(stageThreeOutput)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv4_6', padding='same')(stageFourInput)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (7, 7, 7), name = 'conv4_7', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv4_8', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        StageOneLongcut = layers.Conv3D(32, (1, 1, 1), name = 'conv5_1', padding='same')(StageOneLongcut)
        StageOneLongcut = layers.LeakyReLU()(StageOneLongcut)

        X = layers.Conv3D(32, (1, 1, 1), name = 'conv5_2', padding='same')(stageFourOutput)
        X = layers.LeakyReLU()(X)
        X = layers.UpSampling3D((2, 2, 2))(X)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv5_6', padding='same')(stageFiveInput)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (7, 7, 7), name = 'conv5_7', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(32, (1, 1, 1), name = 'conv5_8', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.UpSampling3D((2, 2, 2))(stageThreeOutput)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.Conv3D(64, (1, 1, 1), name = 'conv6_4', padding='same')(stageSixTwoStack)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(64, (7, 7, 7), name = 'conv6_5', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(64, (1, 1, 1), name = 'conv6_6', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        Y = layers.Conv3D(64, (1, 1, 1), name = 'conv7_1', padding='same')(stageFiveOutput)
        ...
        X = layers.Conv3D(64, (1, 1, 1), name = 'conv7_5', padding='same')(stageSevenInput)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(64, (9, 9, 9), name = 'conv7_6', padding='same')(X)
        X = layers.LeakyReLU()(X)
        X = layers.Conv3D(64, (1, 1, 1), name = 'conv7_7', padding='same')(X)
        X = layers.LeakyReLU()(X)
        ...
        X = layers.Conv3D(1, (1, 1, 1), name = 'conv8', padding='same')(stageSevenOutput)
        X = layers.LeakyReLU()(X)
