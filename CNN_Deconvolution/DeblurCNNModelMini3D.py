...
class DeblurCNNModelMini3D:
    ...
    def ModelBuilder(input_shape=(64, 64, 40, 1), learning_rate=0.001):
        ...
        X = layers.Conv3D(32, (1, 1, 1), name="conv1_1", padding="same")(
            stageZeroOutput
        )
        ...
        StageTwoLongcut = layers.Conv3D(32, (1, 1, 1), name="conv4_1", padding="same")(
            StageTwoLongcut
        )
        StageTwoLongcut = layers.LeakyReLU()(StageTwoLongcut)

        X = layers.Conv3D(32, (1, 1, 1), name="conv4_2", padding="same")(
            stageThreeOutput
        )
        X = layers.LeakyReLU()(X)
        ...
        StageOneLongcut = layers.Conv3D(32, (1, 1, 1), name="conv5_1", padding="same")(
            StageOneLongcut
        )
        StageOneLongcut = layers.LeakyReLU()(StageOneLongcut)

        X = layers.Conv3D(32, (1, 1, 1), name="conv5_2", padding="same")(
            stageFourOutput
        )
        X = layers.LeakyReLU()(X)
        X = layers.UpSampling3D((2, 2, 2))(X)
        ...
        X = layers.Conv3D(64, (1, 1, 1), name="conv6_4", padding="same")(
            stageSixTwoStack
        )
        X = layers.LeakyReLU()(X)
        ...
        Y = layers.Conv3D(64, (1, 1, 1), name="conv7_1", padding="same")(
            stageFiveOutput
        )
        ...
        X = layers.Conv3D(64, (1, 1, 1), name="conv7_5", padding="same")(
            stageSevenInput
        )
        X = layers.LeakyReLU()(X)
