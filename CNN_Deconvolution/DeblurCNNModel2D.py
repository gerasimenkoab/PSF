...
class DeblurCNNModel2D:
    ...
    def ModelBuilder(input_shape = (40, 40, 1), learning_rate = 0.001):
        ...
        StageTwoLongcut = layers.Conv2D(32, (1, 1), name = 'conv4_1', padding='same')(StageTwoLongcut)
        ...
        StageOneLongcut = layers.Conv2D(32, (1, 1), name = 'conv5_1', padding='same')(StageOneLongcut)
